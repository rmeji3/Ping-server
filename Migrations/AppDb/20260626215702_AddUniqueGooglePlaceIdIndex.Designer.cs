...
namespace Ping.Migrations.AppDb
{
    ...
    [Migration("20260626215702_AddUniqueGooglePlaceIdIndex")]
    partial class AddUniqueGooglePlaceIdIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ping.Models.Reviews.Review", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AdditionalImageUrls")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Ping.Models.Search.SearchHistory", b =>
                {
                    ...
                    b.Property<string>("PingGenreName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Ping.Models.Stickers.ProfileStickerPlacement", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProfileStickerPlacements");
                });

            modelBuilder.Entity("Ping.Models.Stickers.Sticker", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Ping.Models.Stickers.UserSticker", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Ping.Models.Stickers.ProfileStickerPlacement", b =>
                {
                    b.HasOne("Ping.Models.Stickers.Sticker", "Sticker")
                        .WithMany()
